...
class TestPresets(unittest.TestCase):
    ...
    def test_to_dict_and_from_dict(self):
        from depthforge.core.presets import get_preset, Preset
    ...
    def test_register_custom_preset(self):
        from depthforge.core.presets import get_preset, register_preset, list_presets, Preset
...
class TestComfortAnalyzer(unittest.TestCase):
    ...
    def _get_analyzer(self, **kwargs):
        ...
        return ComfortAnalyzer(ComfortAnalyzerParams(
    ...
    def test_violations_list_not_empty_on_failure(self):
        ...
        analyzer = ComfortAnalyzer(ComfortAnalyzerParams(
            frame_width=640, max_parallax_fraction=0.001, depth_factor=0.5
        ))
        report = analyzer.analyze(_sphere_depth(64, 96))
...
class TestVergenceStrain(unittest.TestCase):
    ...
    def test_returns_dict_with_required_keys(self):
        ...
        for key in ["mean_vergence_deg", "max_vergence_deg", "vergence_range_deg",
                    "rapid_change_fraction", "strain_rating"]:
...
class TestQCOverlays(unittest.TestCase):
    ...
    def test_comparison_grid_shape(self):
        ...
        imgs = [
            np.random.randint(0, 255, (64, 96, 4), dtype=np.uint8)
            for _ in range(4)
        ]
...
class TestPhase2Integration(unittest.TestCase):
    ...
    def test_preset_workflow(self):
        ...
        analyzer = ComfortAnalyzer(ComfortAnalyzerParams(
            frame_width=96, frame_height=64,
    ...
    def test_safety_limiter_then_synthesize(self):
        ...
        limiter = SafetyLimiter(SafetyLimiterParams(
